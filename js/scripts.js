				    ...
				    complete: function() { 
				    	...
				    	switch(page) {
                            ...
                            case 'fluxo/comercial_g':
	                            if (self.usr.Perfil.DescPerfil !== "Gerente Comercial" && self.usr.Perfil.DescPerfil !== "Administrator") {
                            ...
                            case 'fluxo/comercial_d':
                            	if (self.usr.Perfil.DescPerfil !== "Diretor Comercial"  && self.usr.Perfil.DescPerfil !== "Administrator") {
	                            	$(".save_button").addClass("hide");
	                            } else {
	                            	$(".save_button").removeClass("hide");
	                            }
                            ...
                            break;
                            case 'fluxo/produto':
                            	if (self.usr.Perfil.DescPerfil !== "Gerente de Produto - Projetos Especiais"  && self.usr.Perfil.DescPerfil !== "Administrator") {
	                            	$(".save_button").addClass("hide");
	                            } else {
	                            	$(".save_button").removeClass("hide");
	                            }
                            ...
                            case 'fluxo/supply_chain':
                            	if (self.usr.Perfil.DescPerfil !== "Gerente de Supply Chain"  && self.usr.Perfil.DescPerfil !== "Administrator") {
	                            	$(".save_button").addClass("hide");
	                            } else {
	                            	$(".save_button").removeClass("hide");
	                            }
                            ...
                            case 'fluxo/financeiro_cus':
                            	if (self.usr.Perfil.DescPerfil !== "Gerente Financeiro/Custos"  && self.usr.Perfil.DescPerfil !== "Administrator") {
	                            	$(".save_button").addClass("hide");
	                            } else {
	                            	$(".save_button").removeClass("hide");
	                            }
                            ...
                            case 'fluxo/financeiro_cre':
                            	if (self.usr.Perfil.DescPerfil !== "Gerente Financeiro/Crédito"  && self.usr.Perfil.DescPerfil !== "Administrator") {
	                            	$(".save_button").addClass("hide");
	                            } else {
	                            	$(".save_button").removeClass("hide");
	                            }
                            ...
                            case 'fluxo/importacao':
                            	if (self.usr.Perfil.DescPerfil !== "Gerente Importação/Negociação"  && self.usr.Perfil.DescPerfil !== "Administrator") {
	                            	$(".save_button").addClass("hide");
	                            } else {
	                            	$(".save_button").removeClass("hide");
	                            }
                            ...
                            case 'fluxo/superintendencia':
                            	if (self.usr.Perfil.DescPerfil !== "Superintendente"  && self.usr.Perfil.DescPerfil !== "Administrator") {
	                            	$(".save_button").addClass("hide");
	                            } else {
	                            	$(".save_button").removeClass("hide");
	                            }
		    ...
		    */
	        ...
	        prazoPrecoQuantidade: function(code) {
				...
				$('#exportByAir').click(function() {
                	var modal = new Modal();
    				modal.open('Atenção!',"O frete aéreo é em média x% mais caro que o frete marítimo.",!0,!1);
				});
            ...
            financeiro_cre: function(code) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        var retorno = JSON.parse(data);
                        var retornoData = JSON.parse(retorno[0].Aprovacao);
                        $('#evaluationDate').append(retornoData.Data_Financeiro_Credito);
                    },
                });
